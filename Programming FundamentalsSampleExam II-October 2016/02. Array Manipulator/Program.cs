...
namespace _02.Array_Manipulator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (command != "end")
            {
                ...
                if (commandInfo.Length == 2)
                {
                    ...
                    switch (order)
                    {
                        case "exchange":
                            ...
                            break;
                        case "max":
                            GetMax(numbers, commandInfo[1]);
                            break;
                        case "min":
                            GetMin(numbers, commandInfo[1]);
                            break;
                    }
                }
                else
                {
                    ...
                    GetFirstLast(numbers, order, count, type);
                }
        ...
        private static void GetFirstLast(List<int> numbers, string order, int count, string type)
        {
        ...
        private static void GetMin(List<int> numbers, string type)
        {
        ...
        private static void GetMax(List<int> numbers, string type)
        {
            List<int> filtered = new List<int>();
            if (type == "odd")
            {
        ...
        private static List<int> GetExchange(List<int> numbers, int index)
        {
