...
namespace _09.Legendary_Farming
{
    class Program
    {
        ...
        static void PrintRest(SortedDictionary<string,int>keyItems,SortedDictionary<string,int>junkItems)
        {
        ...
        static void Results(SortedDictionary<string,int>keyItems,SortedDictionary<string,int>junkItems)
        {
        ...
        static void SortItems(string loot,SortedDictionary<string,int>keyItems,SortedDictionary<string,int>junkItems)
        {
